...
<body data-silex-id="body-initial" class="body-initial silex-runtime" data-silex-type="container">
    ...
    <div data-silex-type="text" class="editable-style silex-id-1492895487595-0 text-element" data-silex-id="silex-id-1492895487595-0">
        <div class="silex-element-content normal">
            <h2>
                <font face="Bree Serif" class="heading2" size="7">Dj N8</font>
            </h2>
        </div>
    </div>
    <div data-silex-type="html" class="editable-style silex-id-1492895716230-1 html-element" data-silex-id="silex-id-1492895716230-1">
        <div class="silex-element-content">Follow Dj N8 on Spotify!
            <link rel="" https:="" editor.silex.me="" libs="" templates="" silex-blank-templates="" blank="" editable.htmlhref="" title="" type="">
        </div>
    </div>
</body>
...
<head>
    ...
    <style class="silex-inline-styles" type="text/css">
        .body-initial {
            background-color: rgba(190, 243, 255, 1);
        }
        
        .silex-id-1492895487595-0 {
            min-height: 102px;
            width: 333px;
            top: 1px;
            left: 3px;
    ...
    <script type="text/javascript" class="silex-json-styles">
        [{"desktop":{"body-initial":{"background-color":"rgba(190,243,255,1)"},"silex-id-1474394621033-3":{"min-height":"600px","top":"5px","left":"0px"},"silex-id-1474394621032-2":{"min-height":"100px","background-color":"rgb(255, 255, 255)"},"silex-id-1474394605264-1":{"min-height":"100px","width":"100px","top":"100px","left":"100px"},"silex-id-1474394605263-0":{"min-height":"100px","background-color":"transparent"},"silex-id-1442914737143-3":{"min-height":"36px","width":"960px","top":"37px","left":"1px"},"silex-id-1492895487595-0":{"min-height":"102px","width":"333px","top":"1px","left":"3px"},"silex-id-1492895716230-1":{"min-height":"38px","width":"132px","background-color":"rgb(255, 255, 255)","top":"189px","left":"91px"}},"mobile":{},"componentData":{}}]
    </script>
    ...
    <link href="http://fonts.googleapis.com/css?family=Bree+Serif" rel="stylesheet" type="text/css" class="silex-custom-font">
